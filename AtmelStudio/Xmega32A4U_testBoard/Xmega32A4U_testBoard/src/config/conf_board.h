...
//Режимы:
#define BOARD_TEST					//Отладочная плата
//#define BOARD_MAIN					//Проектная плата
...
///*
	//PORT A
	#define pin_iECIS	IOPORT_CREATE_PIN(PORTA, 0)			//SPI SS, разрешение чтения
	#define pin_iWRIS	IOPORT_CREATE_PIN(PORTA, 1)			//SPI SS, запись
	#define pin_iECSV	IOPORT_CREATE_PIN(PORTA, 2)		//SPI SS, разрешение чтения СКАНИРУЮЩЕГО НАПРЯЖЕНИЯ
	#define pin_iWRSV	IOPORT_CREATE_PIN(PORTA, 3)		//SPI SS, запись СКАНИРУЮЩЕГО НАПРЯЖЕНИЯ
	#define pin_iWRCV	IOPORT_CREATE_PIN(PORTA, 4)			//SPI SS, запись
	#define pin_iECVD	IOPORT_CREATE_PIN(PORTA, 5)			//SPI SS, разрешение чтения
	#define pin_iWRVD	IOPORT_CREATE_PIN(PORTA, 6)			//SPI SS, запись
	#define pin_iEDCD	IOPORT_CREATE_PIN(PORTA, 7)			//SPI SS, разрешение чтения
	//PORT B
