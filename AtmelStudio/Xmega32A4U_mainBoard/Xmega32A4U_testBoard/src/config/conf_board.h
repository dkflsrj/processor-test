...
//------------------------------------КОНФИГУРАЦИИ ДЛЯ МК МСП---------------------------------------
	//PORT A
	#define pin_iECIS	IOPORT_CREATE_PIN(PORTA, 0)		//SPI SS, разрешение чтения Ионного Источника
	#define pin_iWRIS	IOPORT_CREATE_PIN(PORTA, 1)		//SPI SS, запись Ионного Источника
